module.exports.tasks = {
	...
	sass: {
		kickoff: {
			...
			files: {
				'<%=config.css.distDir%>/<%=config.css.srcFile%>.css': '<%=config.css.scssDir%>/<%=config.css.srcFile%>.scss',
				'<%=config.css.distDir%>/<%=config.css.srcFile%>-old-ie.css': '<%=config.css.scssDir%>/<%=config.css.srcFile%>-old-ie.scss'
			}
		}
	},
